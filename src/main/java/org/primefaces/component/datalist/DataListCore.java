...
@PFComponent(tagName = "dataList",
             ...
             widget = true,
             rtl = true)
public abstract class DataListCore extends UIData implements IDataList, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder, org.primefaces.component.api.Pageable {
