...
@PFComponent(tagName = "accordionPanel",
             ...
             widget = true,
             rtl = true)
public abstract class AccordionPanelCore extends UITabPanel implements IAccordionPanel, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
