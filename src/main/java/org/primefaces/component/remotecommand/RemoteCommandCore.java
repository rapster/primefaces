...
public abstract class RemoteCommandCore extends UICommand implements IRemoteCommand, org.primefaces.component.api.AjaxSource {

	@PFPropertyKeys(base = {org.primefaces.component.api.propertykeys.UICommandPropertyKeys.class})
	public enum PropertyKeys {

		@PFProperty(description = "Name of the command")
		name,
		@PFProperty(description = "Component(s) to update with ajax")
		update,
		...
		async,
		@PFProperty(description = "When set to true, command will be invoked on page load", defaultValue = "false", type = Boolean.class)
		autoRun,
