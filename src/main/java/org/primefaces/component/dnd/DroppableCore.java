...
@PFComponent(tagName = "droppable",
             ...
             widget = true,
             rtl = true)
public abstract class DroppableCore extends UIComponentBase implements IDroppable, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
