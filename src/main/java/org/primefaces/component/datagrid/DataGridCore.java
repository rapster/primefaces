...
@PFComponent(tagName = "dataGrid",
             ...
             widget = true,
             rtl = true)
public abstract class DataGridCore extends UIData implements IDataGrid, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder, org.primefaces.component.api.Pageable {
