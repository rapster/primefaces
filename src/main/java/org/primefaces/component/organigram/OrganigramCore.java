...
@PFComponent(tagName = "organigram",
             ...
             widget = true,
             rtl = true)
public abstract class OrganigramCore extends UIComponentBase implements IOrganigram, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
