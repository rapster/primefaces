...
@PFComponent(tagName = "selectBooleanCheckbox",
             ...
             widget = true,
             rtl = true)
public abstract class SelectBooleanCheckboxCore extends HtmlSelectBooleanCheckbox implements ISelectBooleanCheckbox, org.primefaces.component.api.InputHolder {
