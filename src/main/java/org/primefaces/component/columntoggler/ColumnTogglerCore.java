...
@PFComponent(tagName = "columnToggler",
             ...
             widget = true,
             rtl = true)
public abstract class ColumnTogglerCore extends UIComponentBase implements IColumnToggler, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
