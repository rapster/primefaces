...
@PFComponent(tagName = "orderList",
             ...
             widget = true,
             rtl = true)
public abstract class OrderListCore extends UIInput implements IOrderList, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
