...
@PFComponent(tagName = "slider",
             ...
             widget = true,
             rtl = true)
public abstract class SliderCore extends UIComponentBase implements ISlider, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
