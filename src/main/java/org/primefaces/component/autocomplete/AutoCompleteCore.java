...
@PFComponent(tagName = "autoComplete",
             ...
             widget = true,
             rtl = true)
public abstract class AutoCompleteCore extends HtmlInputText implements IAutoComplete, org.primefaces.component.api.InputHolder, org.primefaces.component.api.MixedClientBehaviorHolder {
