...
@PFComponent(tagName = "socket",
             ...
             widget = true,
             rtl = true)
public abstract class SocketCore extends UIComponentBase implements ISocket, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
