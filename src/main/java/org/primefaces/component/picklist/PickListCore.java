...
@PFComponent(tagName = "pickList",
             ...
             widget = true,
             rtl = true)
public abstract class PickListCore extends UIInput implements IPickList, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
