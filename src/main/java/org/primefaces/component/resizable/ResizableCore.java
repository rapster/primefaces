...
@PFComponent(tagName = "resizable",
             ...
             widget = true,
             rtl = true)
public abstract class ResizableCore extends UIComponentBase implements IResizable, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
