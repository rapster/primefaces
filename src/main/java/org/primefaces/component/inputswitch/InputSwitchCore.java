...
@PFComponent(tagName = "inputSwitch",
             ...
             widget = true,
             rtl = true)
public abstract class InputSwitchCore extends UIInput implements IInputSwitch, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
