...
@PFComponent(tagName = "idleMonitor",
             ...
             widget = true,
             rtl = true)
public abstract class IdleMonitorCore extends UIComponentBase implements IIdleMonitor, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
