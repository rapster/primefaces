...
@PFComponent(tagName = "tagCloud",
             ...
             widget = true,
             rtl = true)
public abstract class TagCloudCore extends UIOutput implements ITagCloud, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {

	@PFPropertyKeys(base = {})
	public enum PropertyKeys {

		@PFProperty(description = "", type = org.primefaces.model.tagcloud.TagCloudModel.class, required = true)
		model,
