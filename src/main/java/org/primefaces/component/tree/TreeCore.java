...
@PFComponent(tagName = "tree",
             ...
             widget = true,
             rtl = true)
public abstract class TreeCore extends UITree implements ITree, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
