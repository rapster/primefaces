...
@PFComponent(tagName = "knob",
             ...
             widget = true,
             rtl = true)
public abstract class KnobCore extends UIInput implements IKnob, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
