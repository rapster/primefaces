...
@PFComponent(tagName = "dashboard",
             ...
             widget = true,
             rtl = true)
public abstract class DashboardCore extends UIPanel implements IDashboard, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
