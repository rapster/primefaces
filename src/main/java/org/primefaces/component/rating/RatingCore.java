...
@PFComponent(tagName = "rating",
             ...
             widget = true,
             rtl = true)
public abstract class RatingCore extends UIInput implements IRating, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
