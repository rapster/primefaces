...
@PFComponent(tagName = "treeTable",
             ...
             widget = true,
             rtl = true)
public abstract class TreeTableCore extends UITree implements ITreeTable, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder, org.primefaces.component.api.Pageable {
	...
	public enum PropertyKeys {
		...
		sortFunction,
		@PFProperty(description = "In native mode, treetable uses native checkboxes", defaultValue = "false", type = Boolean.class)
		nativeElements,
		@PFProperty(description = "Locale to be used in features such as sorting, defaults to view locale", type = Object.class)
		dataLocale,
		@PFProperty(description = "Case sensitivity for sorting, insensitive by default", defaultValue = "false", type = Boolean.class)
		caseSensitiveSort,
		@PFProperty(description = "Updates children only when set to \"children\" or the node itself with children when set to \"self\" on node expand", defaultValue = "children")
		expandMode,
		...
		paginatorTemplate,
		@PFProperty(description = "Template of the rowsPerPage dropdown")
		rowsPerPageTemplate,
		@PFProperty(description = "Label for rowsPerPage dropdown")
		rowsPerPageLabel,
		...
		rows,
		@PFProperty(description = "Index of the first data to display", defaultValue = "0", type = Integer.class)
		first,
