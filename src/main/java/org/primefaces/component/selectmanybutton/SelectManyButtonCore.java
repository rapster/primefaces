...
@PFComponent(tagName = "selectManyButton",
             ...
             widget = true,
             rtl = true)
public abstract class SelectManyButtonCore extends UISelectMany implements ISelectManyButton, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
