...
@PFComponent(tagName = "selectCheckboxMenu",
             ...
             widget = true,
             rtl = true)
public abstract class SelectCheckboxMenuCore extends HtmlSelectManyCheckbox implements ISelectCheckboxMenu, org.primefaces.component.api.PrimeClientBehaviorHolder {
