...
@PFComponent(tagName = "progressBar",
             ...
             widget = true,
             rtl = true)
public abstract class ProgressBarCore extends UIComponentBase implements IProgressBar, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
