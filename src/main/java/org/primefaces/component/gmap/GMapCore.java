...
@PFComponent(tagName = "gmap",
             ...
             widget = true,
             rtl = true)
public abstract class GMapCore extends UIComponentBase implements IGMap, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
