...
@PFComponent(tagName = "selectOneButton",
             ...
             widget = true,
             rtl = true)
public abstract class SelectOneButtonCore extends UISelectOne implements ISelectOneButton, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
