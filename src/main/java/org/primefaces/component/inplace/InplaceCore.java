...
@PFComponent(tagName = "inplace",
             ...
             widget = true,
             rtl = true)
public abstract class InplaceCore extends UIComponentBase implements IInplace, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
