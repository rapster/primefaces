...
@PFComponent(tagName = "radioButton",
             ...
             widget = true,
             rtl = true)
public abstract class RadioButtonCore extends UIComponentBase implements IRadioButton {
	...
	public enum PropertyKeys {
		...
		disabled,
		@PFProperty(description = "Index of the selectItem of the selectOneRadio", defaultValue = "0", type = Integer.class)
		itemIndex,
		@PFProperty(description = "Client side callback to execute on state change")
		onchange,
		@PFProperty(description = "Id of the selectOneRadio component to attach to")
		forValue("for"),
