...
@PFComponent(tagName = "schedule",
             ...
             widget = true,
             rtl = true)
public abstract class ScheduleCore extends UIComponentBase implements ISchedule, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
