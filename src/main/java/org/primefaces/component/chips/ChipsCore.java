...
@PFComponent(tagName = "chips",
             ...
             widget = true,
             rtl = true)
public abstract class ChipsCore extends HtmlInputText implements IChips, org.primefaces.component.api.InputHolder, org.primefaces.component.api.MixedClientBehaviorHolder {
