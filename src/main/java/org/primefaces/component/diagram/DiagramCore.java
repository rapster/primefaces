...
@PFComponent(tagName = "diagram",
             ...
             widget = true,
             rtl = true)
public abstract class DiagramCore extends UIOutput implements IDiagram, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {

	@PFPropertyKeys(base = {})
	public enum PropertyKeys {

		@PFProperty(description = "Name of the iterator variable used to refer each data")
		var,
