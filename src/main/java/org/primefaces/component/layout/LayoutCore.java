...
@PFComponent(tagName = "layout",
             ...
             widget = true,
             rtl = true)
public abstract class LayoutCore extends UIPanel implements ILayout, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
