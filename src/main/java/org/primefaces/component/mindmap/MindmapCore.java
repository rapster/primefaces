...
@PFComponent(tagName = "mindmap",
             ...
             widget = true,
             rtl = true)
public abstract class MindmapCore extends UIComponentBase implements IMindmap, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
