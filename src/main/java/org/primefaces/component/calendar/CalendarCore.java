...
@PFComponent(tagName = "calendar",
             ...
             widget = true,
             rtl = true)
public abstract class CalendarCore extends HtmlInputText implements ICalendar, org.primefaces.component.api.InputHolder, org.primefaces.component.api.MixedClientBehaviorHolder {
