...
@PFComponent(tagName = "commandButton",
             ...
             widget = true,
             rtl = true)
public abstract class CommandButtonCore extends HtmlCommandButton implements ICommandButton, org.primefaces.component.api.AjaxSource, org.primefaces.component.api.Confirmable, org.primefaces.component.api.PrimeClientBehaviorHolder {
