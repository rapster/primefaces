...
@PFComponent(tagName = "panel",
             ...
             widget = true,
             rtl = true)
public abstract class PanelCore extends UIPanel implements IPanel, javax.faces.component.behavior.ClientBehaviorHolder, org.primefaces.component.api.PrimeClientBehaviorHolder {
