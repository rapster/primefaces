...
@PFComponent(tagName = "rangeSlider",
             ...
             widget = true,
             rtl = true)
public abstract class RangeSliderCore extends UIComponentBase implements IRangeSlider {
	...
	public enum PropertyKeys {
		...
		styleClass,
		@PFProperty(description = "Highlights the value range when enabled", defaultValue = "true", type = Boolean.class)
		highlight,;
	}
